...
class _AddProductFullState extends State<AddProductFull> {
  ...
  final TextEditingController specificationProductCtrl =
      TextEditingController();
  final TextEditingController noSeriProductCtrl = TextEditingController();

  final UsersController userCtrl = UsersController(); // nip pengguna
  final AddProductController addCtrl = AddProductController();
  final CategoryProductController categoryProductController = // jenis barang
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        if (addCtrl.isLoading.isFalse) {
                          if (codeProductCtrl.text.isNotEmpty &&
                              nipUserProductCtrl.text.isNotEmpty &&
                              nameProductCtrl.text.isNotEmpty &&
                              categoryProductCtrl.text.isNotEmpty &&
                              specificationProductCtrl.text.isNotEmpty &&
                              statusProductCtrl.text.isNotEmpty) {
                            if (codeProductCtrl.text.contains(' ')) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content: Text(
                                          "Kode Barang Tidak Boleh Mengandung Spasi")));
                            } else {
                              addCtrl.isLoading(true);

                              Map<String, dynamic> request =
                                  await addCtrl.addProduct({
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text("Value harus di isi!")));
                          }
                        }
                      },
                      child: Obx(() => Text(
                          addCtrl.isLoading.isFalse ? "TAMBAH BARANG" : "...",
