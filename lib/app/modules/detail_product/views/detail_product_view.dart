...
class DetailProductView extends GetView<DetailProductController> {
  ...
  final TextEditingController spesifikasiC = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    spesifikasiC.text = product.spesifikasi;
    jenisbarangC.text = product.jenisbarang;
