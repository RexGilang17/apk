...
import 'package:qr_code/app/data/models/category_product_model.dart';
import 'package:qr_code/app/data/models/product_model.dart';
import 'package:qr_code/app/data/models/user_model.dart';
import 'package:qr_code/app/modules/category_product/controllers/category_product_controller.dart';
import 'package:qr_code/app/modules/users/controllers/users_controller.dart';
...
class _DetailProductFullState extends State<DetailProductFull> {
  ...
  final TextEditingController nameCtrl2 = TextEditingController(text: "name_2");

  final TextEditingController categoryCtrl = TextEditingController();
  final TextEditingController specCtrl = TextEditingController();
  final TextEditingController statusCtrl = TextEditingController();
  final TextEditingController noSeriCtrl = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    noSeriCtrl.text = product.noSeri;

    statusProductSelected = product.status;

    return Scaffold(
        appBar: AppBar(
          title: const Text('KETERANGAN BARANG',
              ...
              return ListView(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    value: userNipSelected2.isEmpty
                        ? userNipSelected
                        : userNipSelected2,
                    items: _allUser.map((UserModel user) {
                      return DropdownMenuItem<String>(
                          value: user.nip, child: Text(user.nip));
                    }).toList(),
                  ...
                  StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      for (var element in snapshot.data!.docs) {
                        _allCategory
                            .add(CategoryProductModel.fromJson(element.data()));
                      }

                      return DropdownButtonFormField<String>(
                        value: categoryProductSelected2.isEmpty
                            ? categoryProductSelected
                            : categoryProductSelected2,
                  ...
                  DropdownButtonFormField(
                    value: statusProductSelected2.isEmpty
                        ? statusProductSelected
                        : statusProductSelected2,
                    ...
                    onPressed: () async {
                      if (detailCtrl.isLoading.isFalse) {
                        ...
                        Map<String, dynamic> req =
                            await detailCtrl.editProduct({
                          "kode_barang": product.code,
                          "jenis_barang": categoryProductSelected2.isEmpty
                              ? categoryProductSelected
                              : categoryProductSelected2,
                          "nama_barang": nameCtrl.text,
                          "nip": userNipSelected2.isEmpty
                              ? userNipSelected
                              : userNipSelected2,
                          "spesifikasi": specCtrl.text,
                          "status_barang": statusProductSelected2.isEmpty
                              ? statusProductSelected
                              : statusProductSelected2,
                          "no_seri": noSeriCtrl.text
                        });
                        ...
                        if (!req['error']) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text("Berhasil Edit Barang")));
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text("Gagal Edit Barang")));
                        }
                      }
                    },
                    child: Obx(
                      () => Text(
                          detailCtrl.isLoading.isFalse ? "EDIT BARANG" : "...",
                  ...
                  TextButton(
                      onPressed: () {
                        Get.defaultDialog(
                            title: "Hapus Barang",
                            middleText:
                                "Apakah kamu yakin untuk hapus barang ini?",
                            actions: [
                              OutlinedButton(
                                  onPressed: () => Get.back(),
                              ...
                              ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    Map<String, dynamic> res = await detailCtrl
                                  ...
                                  child: Obx(() => Text(
                                      detailCtrl.isLoadDelete.isFalse
                                          ? "HAPUS"
                                          : "...",
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold,
